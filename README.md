...
Persian Streams یک افزونه غیررسمی برای Stremio است که با دریافت شناسه IMDb از Stremio، صفحه محتوای متناظر را در منبع ایرانی تنظیم‌شده پیدا می‌کند و لینک‌های مستقیم پخش/دانلود را به Stremio برمی‌گرداند.
