...
## 📥 نصب سریع - آماده استفاده

> **ساده‌ترین و سریع‌ترین راه برای استفاده از افزونه، نصب مستقیم از سرور آماده است. بدون نیاز به نصب محلی یا تنظیمات اضافه!**
...
#### روش ۱: نصب با یک کلیک (پیشنهادی - دسکتاپ)

روی دکمه زیر کلیک کنید تا مستقیماً در برنامه Stremio باز شود:

### [👉 کلیک کنید برای نصب افزونه در Stremio](stremio://stremio.alirostami.com/streams/manifest.json)

یا این آدرس را در مرورگر خود کپی و باز کنید:

```text
stremio://stremio.alirostami.com/streams/manifest.json
```

#### روش ۲: نصب دستی در اپلیکیشن Stremio

1. برنامه **Stremio** را باز کنید
2. از منوی بالا روی آیکون **افزونه‌ها (Addons)** با شکل پازل 🧩 کلیک کنید
3. در پایین لیست، روی **نوار جستجوی URL** کلیک کنید یا آدرس زیر را در مرورگر جستجوی افزونه وارد کنید:
   ```text
   https://stremio.alirostami.com/streams/manifest.json
   ```
4. افزونه **Persian Streams** نمایش داده می‌شود، روی دکمه **Install** کلیک کنید

#### روش ۳: نصب در Stremio نسخه وب

1. وارد وب‌اپلیکیشن Stremio شوید: [https://web.strem.io](https://web.strem.io)
2. مستقیماً از طریق این لینک افزونه را نصب کنید:
   **[نصب در Stremio Web](https://web.strem.io/addons?addon=https://stremio.alirostami.com/streams/manifest.json)**

> بعد از نصب، کافیست هر فیلم یا سریالی که شناسه IMDb دارد را باز کنید تا لینک‌های پخش فارسی به صورت خودکار در لیست استریم‌ها نمایش داده شود.
